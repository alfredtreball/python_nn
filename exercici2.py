...
class NeuralNetwork:
    def __init__(self):
        ...
        # Inicialització dels pesos i bias amb valors aleatoris
...
nn.train(X_train, y_train, learning_rate=0.1, epochs=11000)

# Realitzar alimentació cap endavant
output = nn.feedforward(X_train)

print("Sortida desitjada [0, 1] per [0, 1]:", output)